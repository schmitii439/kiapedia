...
const verschwörungsKategorien = [
  {
    ...
    topics: [
      { id: 101, title: "Chemtrails", year: 1996, description: "Theorie über angebliche chemische Zusätze in Flugzeugabgasen zur Wetterveränderung oder Bevölkerungskontrolle.", truthRating: 3 },
      { id: 102, title: "Sonnenspiegel", year: 2010, description: "Behauptung, dass riesige Spiegel im Weltall installiert werden, um Sonnenlicht zurück ins All zu reflektieren.", truthRating: 6 },
      { id: 103, title: "Wetterkontrolle", year: 1953, description: "Verschwörungstheorie über staatliche Programme zur künstlichen Kontrolle von Wetterphänomenen.", truthRating: 5 }
    ]
  },
  {
    id: 2,
      ...
      >
        <div className="mb-6">
          ...
          <div className="flex flex-col md:flex-row gap-4 bg-gray-700/50 p-4 rounded-lg mb-6 backdrop-blur-sm border border-cyan-500/20">
            ...
            <div className="flex-1">
              <label className="block text-sm text-gray-400 mb-1">Filtern nach Wahrheitsgrad</label>
              <div className="flex space-x-2">
                <Button 
